                        ...
                        data = [
                            {
                                ...
                                "time": frame.get_value("timestamp").astimezone(timezone('Europe/Paris'))
                                ...
                                "enhanced_speed": frame.get_value("enhanced_speed")
                                if frame.has_field("enhanced_speed")
                                else None,
                                "enhanced_altitude": frame.get_value(
                                    "enhanced_altitude"
                                )
                                if frame.has_field("enhanced_altitude")
                                else None,
                                "heart_rate": frame.get_value(
                                    "heart_rate"
                                )
